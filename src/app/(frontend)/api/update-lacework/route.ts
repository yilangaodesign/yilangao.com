  ...
  content: createCaseStudyBlocks([
    {
      ...
      imagePlaceholders: [
        ['Before: Navigation with License buried 5 layers deep', 'After: Restructured IA with Account grouping at 3 layers'],
        ['Before: Old navigation bar with 12+ tabs', 'After: Simplified navigation bar with Account section'],
        ['Subscription overview page with usage thumbnail', 'Usage detail page - drill-down from thumbnail'],
      ],
    },
    {
