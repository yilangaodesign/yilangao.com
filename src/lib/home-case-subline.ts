/**
 * Secondary line under the headline on the home case-study list (title-style caps
 * per word). Headlines use sentence style in `case-study-intro-headline.ts`.
 * Keyed by project slug so order in CMS does not matter.
 */
