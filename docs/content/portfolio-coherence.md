...
| **Metric type** | Absolute reduction (12K to 560) | Percentage improvement (58%) | Percentage improvement (72% vs 0% on subtle tasks) | N/A |
...
- **Metric types:** Elan and Lacework now both use "percentage improvement" — 2/3 case studies share a metric type. Acceptable (both are percentages but measure fundamentally different things: usability scores vs retrieval accuracy). A 5th entry should use a different metric type. For dimensions marked N/A, the diversity gate skips the repetition check. N/A vs N/A is not a repetition.
