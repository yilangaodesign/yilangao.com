...
> **Last updated:** 2026-04-07 (ENG-131: EditableText `inlineTypography`; EAP-073)
...
| CMS UX / inline editing | 35 | **Critical — ESCALATED. ENG-027→039, ENG-042→046, ENG-049→051, ENG-054→058, ENG-062→063, ENG-066→068, ENG-105, ENG-110, ENG-111, ENG-114, ENG-115, ENG-123, ENG-131, ENG-132. ENG-132: `addImageToBlock` deleted `placeholderLabels` on first upload and rendering used binary all-images/all-placeholders conditional, so uploading one image wiped all sibling placeholder slots. Fix: preserve `placeholderLabels`, render per-slot mixed view. See EAP-074.** |
