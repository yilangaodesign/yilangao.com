...
> **Last updated:** 2026-04-11 (ENG-115: progressive asset preloading pipeline; storage §12.5)
...
| CMS UX / inline editing | 36 | **Critical — ESCALATED. ENG-027→039, ENG-042→046, ENG-049→051, ENG-054→058, ENG-062→063, ENG-066→068, ENG-105, ENG-110, ENG-111, ENG-114, ENG-115, ENG-123, ENG-131, ENG-132, ENG-105(relocation). ENG-105: Relocating `EditableText` element by copying SCSS class defaults instead of rendered output — `htmlContent`/`inlineTypography` overrides were ignored. See EAP-081.** |
...
| Infrastructure / storage architecture | 4 | High — ENG-053. Supabase Storage added for cloud file persistence. ENG-055: Added `uploadMedia` API helper for inline file uploads via S3. ENG-060: Filename sanitization for S3-incompatible chars. ENG-135: Image loading optimization — `next/image` with Supabase `remotePatterns`, Payload derived sizes on frontend, responsive `sizes` hints, priority for LCP images. |
