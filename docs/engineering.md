...
| LLM-judge fluency-over-factuality bias | 1 | **Medium — ENG-266. LLM judges gave higher adherence/quality scores to bare LLM (Arm B) despite 6.0% gold-cite rate. Judges reward confident prose over domain-specific accuracy. Design decision rules around the metric with better reliability (preference kappa 0.53 vs Likert kappa 0.24).** |
