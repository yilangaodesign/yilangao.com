...
- Do `design.md` and `engineering.md` use the same Section Index format?
- Do `design-feedback-log.md` and `engineering-feedback-log.md` use the same entry template?
- Do both skills follow the same step structure?
...
| `docs/design.md` | Design principles | During semantic analysis | When promoting patterns |
| `docs/engineering.md` | Engineering principles | During semantic analysis | When promoting patterns |
