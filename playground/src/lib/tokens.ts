...
export const colors = {
  ...
  terra: scale("terra", {
    "05": "#FAF8F6", "10": "#F5F1EC", "20": "#E0D0BF", "30": "#CCB091", "40": "#B89062", "50": "#A4702C", "60": "#915000", "70": "#743B00", "80": "#542A00", "90": "#341B00", "100": "#170D03",
  }),
      ...
      roles: [
        ...
        },
        {
          ...
          tokens: [
            ...
            { emphasis: "minimal", value: "#FAF8F6", token: "$portfolio-surface-terra-minimal", ref: "$portfolio-terra-05", darkValue: "#161616" },
          ],
        },
        {
          role: "overlay",
    ...
    },
    {
      ...
      roles: [
        ...
        },
        {
          role: "brand",
          tokens: [
            { emphasis: "bold", value: "#3336FF", token: "$portfolio-text-brand-bold", ref: "$portfolio-accent-60", legacy: "$portfolio-text-link", darkValue: "#7392FF" },
          ],
        },
        {
          role: "inverse",
    ...
    },
    {
      ...
      roles: [
        ...
        },
        {
          role: "brand",
          tokens: [
            { emphasis: "bold", value: "#3336FF", token: "$portfolio-icon-brand-bold", ref: "$portfolio-accent-60", darkValue: "#7392FF" },
          ],
        },
        {
          role: "inverse",
    ...
    },
    {
      ...
      roles: [
        ...
        },
        {
          role: "brand",
          tokens: [
            { emphasis: "bold", value: "#3336FF", token: "$portfolio-border-brand-bold", ref: "$portfolio-accent-60", legacy: "$portfolio-border-interactive", darkValue: "#4E6CFF" },
          ],
        },
        {
          role: "inverse",
